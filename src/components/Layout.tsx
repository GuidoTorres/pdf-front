  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background/80 text-foreground">
              ...
              <DropdownMenu aria-label="Profile Actions" variant="flat">
                <DropdownItem key="profile" className="h-14 gap-2">
                  <p className="font-semibold">
                    {t("layout.profileMenu.signedInAs")}
                  </p>
                ...
                <DropdownItem key="help_and_feedback">
                  {t("layout.profileMenu.helpAndFeedback")}
                </DropdownItem>
                <DropdownItem
                  key="logout"
                  color="danger"
      ...
      <div className="flex pt-16">
        ...
        {/* Main Content */}
        <main
          className={`flex-1 transition-all duration-300 ease-in-out p-6 pb-16 ${
