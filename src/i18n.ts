...
const resources = {
  en: {
    translation: {
      ...
      historyPage: {
        title: "Document History",
        subtitle: "View and manage your processed documents",
        ...
        aiProcessingAccuracy: "AI processing accuracy",
      },
      loginPage: {
      ...
      settingsPage: {
        ...
        preferences: {
          ...
          emailUpdatesDesc: "Get email notifications",
          language: "Language",
  ...
  es: {
    translation: {
      ...
      historyPage: {
        title: "Historial de Documentos",
        subtitle: "Ve y administra tus documentos procesados",
        ...
        total: "total",
        noSizeData: "Sin datos de tamaño",
        transactionsExtracted: "transacciones extraídas",
        pagesProcessed: "páginas procesadas",
        avgQuality: "Calidad Promedio",
        aiProcessingAccuracy: "Precisión del procesamiento con IA",
      },
      loginPage: {
      ...
      settingsPage: {
        ...
        profile: {
          ...
          cancel: "Cancelar",
          profilePictureManaged:
            "La imagen de perfil es administrada por tu proveedor de autenticación",
        },
        password: {
          ...
          req1: "Al menos 8 caracteres de largo",
          req2: "Contiene letras mayúsculas y minúsculas",
          req3: "Contiene al menos un número",
          req4: "Contiene al menos un carácter especial",
        },
        dangerZone: {
          title: "Zona de Peligro",
          subtitle: "Acciones permanentes que no se pueden deshacer",
        ...
        preferences: {
          ...
          notificationsDesc: "Recibir notificaciones de la app",
          emailUpdates: "Actualizaciones por Email",
          emailUpdatesDesc: "Recibir notificaciones por email",
          language: "Idioma",
